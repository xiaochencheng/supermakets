	...
	$.ajax({
		...
		success:function(data){
			if(data == "true"){//删除成功：移除删除行
				...
				window.location.href="/supermarkets/pro/list.html";
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href="/supermarkets/pro/proView.html?proid="+obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href="/supermarkets/pro/proUp?proid="+ obj.attr("proid");
	});
