	...
	$.ajax({
		...
		success:function(data){
			if(data == "true"){//删除成功：移除删除行
				...
				window.location.href="/supermarkets/bill/list.html";
...
$(function(){
	$(".viewBill").click("click",function(){
		//将被绑定的元素（a）转换成jquery对象，可以使用jquery方法
		var obj = $(this);
		window.location.href="/supermarkets/bill/billVi.html?billid="+ obj.attr("billid");
	});
	
	$(".modifyBill").click("click",function(){
		var obj = $(this);
		window.location.href="/supermarkets/bill/billUpdate?billid="+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
