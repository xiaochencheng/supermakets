...
<div class="right">
       ...
       <form method="get" action="${pageContext.request.contextPath }/bill/list.html">
			...
			<select name="providerId">
				<c:if test="${proname != null }">
				   ...
				   <c:forEach var="provider" items="${proname}">
			...
			<select name="providerId">
				<option value="0">--请选择--</option>
				<option value="1" ${providerId == 1 ? "selected=\"selected\"":"" }>未付款</option>
				<option value="2" ${providerId == 2 ? "selected=\"selected\"":"" }>已付款</option>
       		</select>
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${roleList }" varStatus="status">
				<tr>
					<td>
